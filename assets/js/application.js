...
var Utility = {
    ...
    toggle_leftbar: function() {
        ...
        if ($('body').hasClass('sidebar-collapsed')) {
           $('#trigger-sidebar i').removeClass('fa-arrow-left').addClass('fa-arrow-right');
       } else {
           $('#trigger-sidebar i').removeClass('fa-arrow-right').addClass('fa-arrow-left');
       }
    ...
    animateContent: function () {
        if ($.fn.velocity) {
            $('.animated-content .info-tile, .animated-content .panel:not(.no-animate)')
        ...
        if ($('body').hasClass('infobar-overlay')) {
            if ($('body>header, body.horizontal-nav>#wrapper>header').hasClass('navbar-fixed-top')) {
                if ($('body.infobar-overlay').hasClass('infobar-active')) {
                    $('.infobar-wrapper').css('transform','translate(0, 56px)');
                }
            } else {
                if ($('body.infobar-overlay').hasClass('infobar-active')) {
                    if (scr < headerHeight) {
...
$(document).ready(function () {
        ...
        // if($('body').hasClass('sidebar-collapsed')){
        //     $('#trigger-sidebar .icon-bg i').removeClass('fa-arrow-left').addClass('fa-arrow-right');
        // }
        // else{
        //     $('#trigger-sidebar .icon-bg i').removeClass('fa-arrow-right').addClass('fa-arrow-left');
        // }
    ...
    $(document).on('click', '.btn, .button-icon, .dropdown-toggle, .toolbar-icon-bg > a, ul.acc-menu li a, .logo-area ul.nav li a, .toolbar-trigger > a', function(e){
        var rippler = $(this);
        rippler.addClass('ripple-effect')
    ...
    enquire.register("screen and (max-width: 767px)", {
        match : function() {  //smallscreen
            $('body').addClass('sidebar-collapsed');
            //$('#trigger-sidebar .icon-bg i').removeClass('.fa .fa-arrow-left').addClass('fa fa-arrow-right');
            // if ($('body').hasClass('sidebar-collapsed')) {
                setWidthtoContent();
            // }
        ...
        unmatch : function() {  //bigscreen
            ...
            //$('#trigger-sidebar .icon-bg i').removeClass('.fa .fa-arrow-right').addClass('fa fa-arrow-left');
    ...
    $('#trigger-toolbar-search').click( function() {
        ...
        $("#trigger-sidebar a").addClass('no-border');
        $("#toolbar-search input.form-control").focus();
        $("header#topnav > .toolbar").toggle();
    });

    $("#toolbar-search .input-group-btn .btn").click(function(){
        $("#trigger-sidebar a").removeClass('no-border').addClass('border');
    });
